...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bottom_links: Schema.Attribute.Component<'shared.link', true>;
    content: Schema.Attribute.Blocks;
    copyright: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u00A9 2025 Big Beautiful Boycott'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    logo: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'ui.footer-section', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    nav: Schema.Attribute.Component<'ui.nav-item', true> &
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    faq_subheading: Schema.Attribute.String;
    faqs: Schema.Attribute.Relation<'oneToMany', 'api::faq.faq'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    signup_heading: Schema.Attribute.String;
    signup_subheading: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiReasoningTagReasoningTag
  extends Struct.CollectionTypeSchema {
  collectionName: 'reasoning_tags';
  info: {
    displayName: 'Reasoning tag';
    pluralName: 'reasoning-tags';
